-- Corrigir a função handle_new_user para buscar o created_by nos metadados corretos
...
DECLARE
  ...
  creator_id uuid;
BEGIN
  -- Extrair o ID do criador dos metadados se fornecido (tanto de raw_user_meta_data quanto de data)
  creator_id := COALESCE(
  ...
  RAISE LOG 'handle_new_user: Usuário % criado na conta %', NEW.id, target_account_id;
